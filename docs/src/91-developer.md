...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/EPFL-ENAC/TethysChlorisCore.jl
   ```
...
- After that runs, the [stable docs](https://EPFL-ENAC.github.io/TethysChlorisCore.jl/stable) should be updated. Check them and look for the version number.
